...
var STORE_NAME = "satya-reader-posts";
var BLOB_KEY = "posts.json";
var MAX_POSTS = 300;
var MAX_CONTENT_LEN = 4e3;
var MAX_TITLE_LEN = 200;
var MAX_PHOTO_LEN = 9e5;
var EDITOR_PIN = "Satya@2026";
...
exports.handler = async function(event) {
  ...
  if (event.httpMethod === "PUT") {
    ...
    posts[idx].editedAt = (/* @__PURE__ */ new Date()).toISOString();
    await savePosts(posts);
    return cors({ post: posts[idx] });
  }
